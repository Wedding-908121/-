// Week 34 processor - fetch manual URLs + auto sources + AI summarize
...
async function fetchManualUrls() {
  ...
  for (let i = 0; i < urlEntries.length; i++) {
    ...
    try {
      ...
      let pubDate = new Date('2026-08-17T00:00:00+08:00');
  ...
  try {
    ...
    for (const q of queries) {
      ...
      for (const m of items) {
        ...
        const weekStart = new Date('2026-08-17T00:00:00+08:00');
        const weekEnd = new Date('2026-08-23T23:59:59+08:00');
